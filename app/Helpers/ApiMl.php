            ...
            switch ($autopart->category->id) {
                ...
                case 71: //Faros
                    $additionalAttributes = [
                        ...
                        ["id" => "BULB_TECHNOLOGY", "value_name" => $autopart->bulb_tech[0]->value],
                ...
                case 144: //Luces Stop
                    $additionalAttributes = [
                        ["id" => "BRAKE_LIGHT_POSITION", "value_name" => $autopart->brake_light_pos[0]->value],
                        ["id" => "BULBS_NUMBER", "value_name" => null],
                        ["id" => "BULBS_TYPE", "value_name" => $autopart->bulb_tech[0]->value]
                    ];
                    $attributesList = array_merge($attributesList, $additionalAttributes);
                    break;
