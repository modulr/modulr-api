        ...
        <div class="relative sm:flex sm:justify-center  min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="md:hidden flex justify-center">
                    ...
                    <!-- <img src="/autoglobal.png" alt="Auto Global" class="h-24"> -->
                ...
                @if (isset($store))
                    <div class="flex justify-center mt-8 mb-14">
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 lg:gap-8">
                            ...
                            <a href="/import/save/{{$store->id}}/50" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-center mb-4 px-0 space-y-4 sm:space-y-0 sm:items-center sm:justify-between">
                        <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                            <div class="flex items-center justify-center gap-4">
                                <div class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                    ...
                                    @if (isset($store))
                                        <strong class="ml-1">{{$store->name}}</strong>
                                    @endif
                ...
                <div>
                    ...
                    @if (isset($autoparts))
                        ...
                        <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right my-6">
